(function () {
    ...
    u("Promise", function (a) {
        ...
        e.prototype.U = function () {
            ...
            var k = this, h = !1;
            return {resolve: g(this.Ja), reject: g(this.Z)}
        };
        e.prototype.Ja = function (g) {
            if (g === this) this.Z(new TypeError("A Promise cannot resolve to itself")); else if (g instanceof e) this.Oa(g); else {
                a:switch (typeof g) {
                    case "object":
                        var k = g != null;
                        break a;
        ...
        e.prototype.Ia = function (g) {
            ...
            typeof k == "function" ? this.Pa(k, g) : this.ja(g)
        };
        ...
        e.prototype.Fa = function () {
            if (this.ka) return !1;
            var g = r.CustomEvent, k = r.Event, h = r.dispatchEvent;
            if (typeof h === "undefined") return !0;
            typeof g === "function" ? g = new g("unhandledrejection", {cancelable: !0}) : typeof k === "function" ? g = new k("unhandledrejection", {cancelable: !0}) : (g = r.document.createEvent("CustomEvent"), g.initCustomEvent("unhandledrejection", !1, !0, g));
            g.promise = this;
            g.reason = this.K;
            return h(g)
        };
    ...
    u("Map", function (a) {
        if (function () {
            ...
            try {
                var k = Object.seal({x: 4}), h = new a(y([[k, "s"]]));
                if (h.get(k) != "s" || h.size != 1 || h.get({x: 4}) || h.set({x: 4}, "t") != h || h.size != 2) return !1;
        ...
        var d = function (k, h) {
            ...
            var m = k[0][l];
            if (m && z(k[0], l)) for (k = 0; k < m.length; k++) {
                var n = m[k];
                if (h !== h && n.key !== n.key || h === n.key) return {id: l, list: m, index: k, i: n}
            }
            return {id: l, list: m, index: -1, i: void 0}
        }, e = function (k, h) {
            var l = k[1];
            return da(function () {
                if (l) {
    ...
    window.gapi.Qa = (new Date).getTime();/*

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/
    var A = this || self, ia = function (a) {
        var b = typeof a;
    ...
    }, ka = "closure_uid_" + (Math.random() * 1E9 >>> 0), na = 0, oa = function (a, b, c) {
    ...
    function ua(a, b) {
        if (Error.captureStackTrace) Error.captureStackTrace(this, ua); else {
            var c = Error().stack;
            c && (this.stack = c)
        }
    ...
    var ya = Array.prototype.forEach ? function (a, b) {
        xa(a.length != null);
 ...
 SPDX-License-Identifier: Apache-2.0
*/
    var Ba = "src srcdoc codebase data href rel action formaction sandbox cite poster icon".split(" ");
    var Ca = {};

    function Da() {
        if (Ca !== Ca) throw Error("Bad secret");
    };var Ea = function (a) {
        Da();
        this.qa = a
    };
    ...
    var Qa = Pa(function (a) {
        ...
        return a(Ja)
    }), Ra = Oa(Ka) && Oa(La) && Oa(Ma) && Oa(Na);

    function Sa() {
        var a = Ta;
        if (!Array.isArray(a) || !Array.isArray(a.raw) || a.length !== a.raw.length || !Qa && a === a.raw || !(Qa && !Ra || Oa(a)) || 1 !== a.length) throw new TypeError("\n    ############################## ERROR ##############################\n\n    It looks like you are trying to call a template tag function (fn`...`)\n    using the normal function syntax (fn(...)), which is not supported.\n\n    The functions in the safevalues library are not designed to be called\n    like normal functions, and doing so invalidates the security guarantees\n    that safevalues provides.\n\n    If you are stuck and not sure how to proceed, please reach out to us\n    instead through:\n     - go/ise-hardening-yaqs (preferred) // LINE-INTERNAL\n     - g/ise-hardening // LINE-INTERNAL\n     - https://github.com/google/safevalues/issues\n\n    ############################## ERROR ##############################");
    ...
    function Xa(a) {
        if (a instanceof B) if (a instanceof B) a = a.sa; else throw Error("Unexpected type when unwrapping SafeUrl, got '" + a + "' of type '" + typeof a + "'"); else {
            var b = !Wa.test(a);
            b && Ya(a);
            a = b ? void 0 : a
        }
    ...
    function bb(a) {
        ...
        if (b.map(function (c) {
            if (c instanceof Ea) c = c.qa; else throw Error("Unexpected type when unwrapping SafeAttributePrefix, got '" + c + "' of type '" + typeof c + "'");
            return c
        }).every(function (c) {
        ...
        for (var e = 1; e < c.length; e++) {
            var f = c[e];
            if (!ia(f) || ja(f) && f.nodeType > 0) d(f); else {
                a:{
    ...
    p.appendChild = function (a, b) {
        xa(a != null && b != null, "goog.dom.appendChild expects non-null arguments");
        a.appendChild(b)
    };
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var C = window, D = document, fb = C.location, hb = function () {
    }, ib = /\[native code\]/, E = function (a, b, c) {
        return a[b] = a[b] || c
    }, jb = function (a) {
        ...
        return b
    }, lb = /&/g, mb = /</g, nb = />/g, ob = /"/g, pb = /'/g, qb = function (a) {
        return String(a).replace(lb, "&amp;").replace(mb, "&lt;").replace(nb, "&gt;").replace(ob, "&quot;").replace(pb, "&#39;")
    }, F = function () {
        var a;
        if ((a = Object.create) &&
            ib.test(a)) a = a(null); else {
            a = {};
        ...
        if (ib.test(Object.keys)) return Object.keys(a);
        var b = [], c;
    ...
    var L = function (a, b, c) {
        ...
        vb = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,
            "g"), wb = /%([a-f]|[0-9a-fA-F][a-f])/g, xb = /^(https?|ftp|file|chrome-extension):$/i, yb = function (a) {
            a = String(a);
            ...
            var c = [];
            if (a) for (var d in a) if (G(a, d) && a[d] != null) {
                var e = b ? b(a[d]) : a[d];
            ...
            a = yb(a);
            a.query.push.apply(a.query, Ab(b, d));
            a.l.push.apply(a.l, Ab(c, d));
            return zb(a)
        },
        Cb = new RegExp(/\/?\??#?/.source + "(" + /[\/?#]/i.source + "|" + /[\uD800-\uDBFF]/i.source + "|" + /%[c-f][0-9a-f](%[89ab][0-9a-f]){0,2}(%[89ab]?)?/i.source + "|" + /%[0-9a-f]?/i.source + ")$", "i"),
        Db = function (a, b) {
            var c = yb(b);
            b = c.H;
            ...
            var d = "";
            b.length > 2E3 && (d = b, b = b.substr(0, 2E3), b = b.replace(Cb, ""), d = d.substr(b.length));
            ...
            e.appendChild(a);
            a = e.innerHTML;
            Aa === void 0 && (Aa = ta("gapi#html"));
            b = Aa;
            a = new Ua(b ? b.createHTML(a) : a);
            if (e.nodeType === 1 && (b = e.tagName, b === "SCRIPT" || b === "STYLE")) throw Error(b === "SCRIPT" ? "Use safeScriptEl.setTextContent with a SafeScript." : "Use safeStyleEl.setTextContent with a SafeStyleSheet.");
            if (a instanceof Ua) a = a.ra; else throw Error("Unexpected type when unwrapping SafeHtml");
            e.innerHTML = a;
    ...
    var Gb = function (a, b, c, d) {
        if (C[c + "EventListener"]) C[c + "EventListener"](a, b, !1); else if (C[d + "tachEvent"]) C[d + "tachEvent"]("on" + a, b)
    }, Hb = function () {
        var a = D.readyState;
        ...
        if (Hb()) a(); else {
            ...
            C.addEventListener ? (C.addEventListener("load", c, !1), C.addEventListener("DOMContentLoaded", c, !1)) : C.attachEvent &&
                (C.attachEvent("onreadystatechange", function () {
                    Hb() && c.apply(this, arguments)
                }), C.attachEvent("onload", c))
        }
    }, Lb = function (a) {
        for (; a.firstChild;) a.removeChild(a.firstChild)
    }, Mb = {button: !0, div: !0, span: !0};
    var M = {};
    M = E(C, "___jsl", F());
    E(M, "I", 0);
    E(M, "hel", 10);
    var Nb = function (a) {
        ...
        M.PQ = [];
        var c = b.length;
        if (c === 0) a(); else for (var d = 0, e = function () {
            ++d === c && a()
        }, f = 0; f < c; f++) b[f](e)
    }, Rb = function (a) {
    ...
    var Tb = E(M, "perf", F()), Ub = E(Tb, "g", F()), Vb = E(Tb, "i", F());
    E(Tb, "r", []);
    F();
    F();
    var Wb = function (a, b, c) {
        ...
        Ub[a] = !b && Ub[a] || c || (new Date).getTime();
        Wb(a)
    }, Yb = function (a, b, c) {
        b && b.length > 0 && (b = Xb(b), c && c.length > 0 && (b += "___" + Xb(c)), b.length > 28 && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = E(Vb, "_p", F()), E(b, c, F())[a] = (new Date).getTime(), Wb(a, "_p", c))
    }, Xb = function (a) {
        return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/,/g, "_")
    };
    var Zb = F(), O = [], Q = function (a) {
    ...
    var $b = /^(\/[a-zA-Z0-9_\-]+)+$/, ac = [/\/amp\//, /\/amp$/, /^\/amp$/], bc = /^[a-zA-Z0-9\-_\.,!]+$/,
        cc = /^gapi\.loaded_[0-9]+$/, dc = /^[a-zA-Z0-9,._-]+$/, hc = function (a, b, c, d, e) {
            var f = a.split(";"), g = f.shift(), k = Zb[g], h = null;
            k ? h = k(f, b, c, d) : Q("no hint processor for: " + g);
            h || Q("failed to generate load url");
            b = h;
            c = b.match(ec);
            (d = b.match(fc)) && d.length === 1 && gc.test(b) && c && c.length === 1 || Q("failed sanity: " + a);
            try {
                a = "?";
                if (e && e.length > 0) {
                    c = b = 0;
                    for (d = {}; c < e.length;) {
                        var l = e[c++], m = ja(l) ? "o" + (Object.prototype.hasOwnProperty.call(l,
                            ka) && l[ka] || (l[ka] = ++na)) : (typeof l).charAt(0) + l;
            ...
            a = ic(a);
            cc.test(c) || Q("invalid_callback");
            b = jc(b);
            d = d && d.length ? jc(d) : null;
            var e = function (f) {
                return encodeURIComponent(f).replace(/%2C/g, ",")
            };
            return [encodeURIComponent(a.pathPrefix).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=",
                e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.ca ? "/am=" + e(a.ca) : "", a.ta ? "/rs=" + e(a.ta) : "", a.wa ? "/t=" + e(a.wa) : "", "/cb=", e(c)].join("")
        }, ic = function (a) {
            a.charAt(0) !== "/" && Q("relative path");
            for (var b = a.substring(1).split("/"), c = []; b.length;) {
                a = b.shift();
                if (!a.length || a.indexOf(".") == 0) Q("empty/relative directory"); else if (a.indexOf("=") > 0) {
                    b.unshift(a);
                    break
                }
                c.push(a)
            ...
            for (var d = 0, e = b.length; d < e; ++d) {
                var f = b[d].split("="), g = decodeURIComponent(f[0]), k = decodeURIComponent(f[1]);
                f.length == 2 && g && k &&
                (a[g] = a[g] || k)
            }
            b = "/" + c.join("/");
            $b.test(b) || Q("invalid_prefix");
            c = 0;
            for (d = ac.length; c < d; ++c) ac[c].test(b) && Q("invalid_prefix");
            c = lc(a, "k", !0);
            d = lc(a, "am");
            e = lc(a, "rs");
            a = lc(a, "t");
            return {pathPrefix: b, version: c, ca: d, ta: e, wa: a}
        }, jc = function (a) {
            ...
            return null
        }, gc = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,
        fc = /\/cb=/g, ec = /\/\//g;
    Zb.m = function (a, b, c, d) {
        (a = a[0]) || Q("missing_hint");
        return "https://apis.google.com" + kc(a, b, c, d)
    };
    var mc = decodeURI("%73cript"), nc = /^[-+_0-9\/A-Za-z]+={0,2}$/, oc = function (a, b) {
        for (var c = [], d = 0; d < a.length; ++d) {
            var e = a[d];
            e && jb.call(b, e) < 0 && c.push(e)
        }
        return c
    }, pc = function () {
        var a = M.nonce;
        return a !== void 0 ? a && a === String(a) && a.match(nc) ? a : M.nonce = null : D.querySelector ? (a = D.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(nc) ? M.nonce = a : M.nonce = null) : null : null
    }, sc = function (a) {
        if (D.readyState != "loading") qc(a); else {
            var b = pc(), c = "";
            b !== null && (c = ' nonce="' +
                b + '"');
            a = "<" + mc + ' src="' + encodeURI(a) + '"' + c + "></" + mc + ">";
            D.write(rc ? rc.createHTML(a) : a)
        }
    }, qc = function (a) {
        var b = D.createElement(mc);
        b.setAttribute("src", rc ? rc.createScriptURL(a) : a);
        a = pc();
        a !== null && b.setAttribute("nonce", a);
        b.async = "true";
        (a = D.getElementsByTagName(mc)[0]) ? a.parentNode.insertBefore(b, a) : (D.head || D.body || D.documentElement).appendChild(b)
    }, uc = function (a, b, c) {
        tc(function () {
            var d = b === Nb(fb.href) ? E(K, "_", F()) : F();
            d = E(Rb(b), "_", d);
            a(d)
        }, c)
    }, wc = function (a, b) {
        ...
        (c = {}, c.callback = b);
        var d = (b = c) && b._c;
        if (d) for (var e = 0; e < O.length; e++) {
            var f = O[e][0], g = O[e][1];
            g && G(d, f) && g(d[f], a, b)
        }
        b = [];
        a ? b = a.split(":") : c.features && (b = c.features);
        if (!(a = c.h) && (a = Nb(fb.href), !a)) throw Error("Bad hint: !hint");
        vc(b || [], c, a)
    }, vc = function (a, b, c) {
        a = kb(a) || [];
        ...
        k = E(Rb(c),
            "r", []).sort();
        var n = E(Rb(c), "L", []).sort(), q = M.le || [], v = [].concat(k), w = function (S, la) {
            if (m) return 0;
            C.clearTimeout(l);
            n.push.apply(n, t);
            var ma = ((K || {}).config || {}).update;
            ma ? ma(e) : e && E(M, "cu", []).push(e);
            if (la) {
                Yb("me0", S, v);
                try {
                    uc(la, c, h)
        ...
        if (t.length) {
            ...
            if (t.length) {
                ...
                a = hc(c, t, "gapi." + gb, k, q);
                k.push.apply(k, t);
                Yb("ml0", t, v);
                b.sync || C.___gapisync ? sc(a) : qc(a)
            } else J[P](hb)
        } else w(t) && d && d()
    }, rc = ta("gapi#gapi");
    var tc = function (a, b) {
        if (M.hee && M.hel > 0) try {
            ...
            b && b(c), M.hel--, wc("debug_error", function () {
                try {
    ...
    var R = function (a) {
        ...
        if (b && typeof b === "object") for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && d === "___goc" && typeof b[d] === "undefined" || (a[d] && b[d] && typeof a[d] === "object" && typeof b[d] === "object" && !zc(a[d]) && !zc(b[d]) ? T(a[d], b[d]) : b[d] && typeof b[d] ===
        "object" ? (a[d] = zc(b[d]) ? [] : {}, T(a[d], b[d])) : a[d] = b[d])
    }, Cc = function (a, b) {
        if (a && !/^\s+$/.test(a)) {
            ...
            if (f && f === b || !f && Ac()) if (e = Bc(c), d.push(25), typeof e === "object") return e;
            return {}
        }
    }, Ac = function () {
        ...
        yc(!0);
        var b = window.___gcfg, c = R("cu"), d = window.___gu;
        b && b !== d && (Dc(c, b), window.___gu = b);
        b = R("cu");
        ...
        var f = [];
        f.push.apply(f, R("us"));
        for (var g = 0; g < e.length; ++g) for (var k = e[g], h = 0; h < f.length; ++h) k.src && k.src.indexOf(f[h]) == 0 && d.push(k);
        d.length == 0 && e.length > 0 && e[e.length - 1].src && d.push(e[e.length - 1]);
        for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") || (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = g == 3 || g == 4 ? f.nodeValue : f.textContent || "") : f = void 0, g = d[e].nonce || d[e].getAttribute("nonce"), (f = Cc(f, g)) && b.push(f));
        a && Dc(c, a);
        d = R("cd");
        a = 0;
        for (b = d.length; a < b; ++a) T(yc(),
            d[a], !0);
        d = R("ci");
        a = 0;
        for (b = d.length; a < b; ++a) T(yc(), d[a], !0);
        a = 0;
        for (b = c.length; a < b; ++a) T(yc(), c[a], !0)
    }, U = function (a) {
        var b = yc();
        if (!a) return b;
        a = a.split("/");
    ...
    var Hc = {
        ...
        if (!Ic) {
            ...
            if (window.self !== window.top) {
                ...
                for (var e in Hc) Hc[e] > 0 && (b = L(a, e, "")) && (Jc[e] = b)
            }
            Ic = !0
        }
        e = F();
    ...
    var Sc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        Tc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/b\/(\d{10,21})\//, Uc = function () {
            ...
            a == null && (b = window.location.href, a = L(b, "authuser") ||
                null, a == null && (a = (a = b.match(Sc)) ? a[1] : null));
            ...
            a == null && (a = (a = window.location.href.match(Tc)) ? a[1] : null);
            if (a == null) return null;
            a = String(a);
            a.length > 21 && (a = null);
            return a
        };
    var Wc, Xc, Yc = void 0, X = function (a) {
            try {
        ...
        }, Zc = Y(0), $c = Y(new Date(0)), ad = Y(!0), bd = Y(""), cd = Y({}), dd = Y([]), ed = function (a, b) {
            ...
            if (d !== "undefined") {
                ...
                if (a != null && typeof a.toJSON === "function" && (Object.prototype.hasOwnProperty.call(a,
                    "toJSON") || (e !== dd || a.constructor !== Array && a.constructor !== Object) && (e !== cd || a.constructor !== Array && a.constructor !== Object) && e !== bd && e !== Zc && e !== ad && e !== $c)) return ed(a.toJSON.call(a), c);
                if (a == null) b[b.length] = "null"; else if (e === Zc) a = Number(a), isNaN(a) || isNaN(a - a) ? a = "null" : a === -0 && 1 / a < 0 && (a = "-0"), b[b.length] = String(a); else if (e === ad) b[b.length] = String(!!Number(a)); else {
                    if (e === $c) return ed(a.toISOString.call(a), c);
                    if (e === dd && Y(a.length) === Zc) {
                        b[b.length] = "[";
                        var f = 0;
                        for (d = Number(a.length) >> 0; f < d; ++f) f &&
                        (b[b.length] = ","), b[b.length] = ed(a[f], c) || "null";
                        b[b.length] = "]"
                    } else if (e == bd && Y(a.length) === Zc) {
                        b[b.length] = '"';
                        f = 0;
                        ...
                        for (f in a) Object.prototype.hasOwnProperty.call(a,
                            f) && (e = ed(a[f], c), e !== void 0 && (d++ && (b[b.length] = ","), b[b.length] = ed(f), b[b.length] = ":", b[b.length] = e));
                        b[b.length] = "}"
                    } else return
                }
                return b.join("")
            }
        }, fd = /[\0-\x07\x0b\x0e-\x1f]/, gd = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/,
        hd = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/,
        id = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/,
        jd = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g,
        kd = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g, ld = /[ \t\n\r]+/g,
        md = /[^"]:/, nd = /""/g, od = /true|false|null/g, pd = /00/, qd = /[\{]([^0\}]|0[^:])/,
        rd = /(^|\[)[,:]|[,:](\]|\}|[,:]|$)/, sd = /[^\[,:][\[\{]/, td = /^(\{|\}|\[|\]|,|:|0)+/, ud = /\u2028/g,
        vd = /\u2029/g, wd = function (a) {
            a = String(a);
            if (fd.test(a) || gd.test(a) || hd.test(a) || id.test(a)) return !1;
            var b = a.replace(jd, '""');
            b = b.replace(kd, "0");
            b = b.replace(ld, "");
            if (md.test(b)) return !1;
            b = b.replace(nd, "0");
            b = b.replace(od, "0");
            if (pd.test(b) || qd.test(b) || rd.test(b) || sd.test(b) || !b || (b = b.replace(td, ""))) return !1;
            a = a.replace(ud, "\\u2028").replace(vd,
                "\\u2029");
            b = void 0;
            try {
                b = Yc ? [X(a)] : eval("(function (var_args) {\n  return Array.prototype.slice.call(arguments, 0);\n})(\n" + a + "\n)")
            } catch (c) {
                return !1
            }
            ...
            if ((Wc === void 0 || Yc === void 0 || Xc !== a) && Xc !== -1) {
                Wc = Yc = !1;
                Xc = -1;
                try {
                    try {
                        Yc = !!A.JSON && A.JSON.stringify.call(A.JSON, {
                            a: [3, !0, new Date(0)], c: function () {
                            }
            ...
            if (Xc !== -1) return xd(), Yc ? A.JSON.stringify.call(A.JSON, a) : ed(a)
        },
        Ad = !Date.prototype.toISOString || typeof Date.prototype.toISOString !== "function" || (new Date(0)).toISOString() !== "1970-01-01T00:00:00.000Z",
        Bd = function () {
    ...
    var Fd = function () {
        ...
        this.ya = "/js/gen_204";
        var c = Sb();
        c && (this.url = "" + c + this.ya, c = W("gen204logger") || {}, this.W = c.interval, this.ia = c.rate, this.S = c.Ra, a && this.url && Ed(this), document.addEventListener("visibilitychange", this.flush), this.flush(), document.addEventListener("visibilitychange", function () {
        ...
        if (b && b.length !==
            0) {
            b = y(b);
            for (var c = b.next(); !c.done; c = b.next()) Dd(Gd(a, c.value), 1, !1);
            delete M.dm;
            a.flush()
        }
    }, Gd = function (a, b) {
        a.M.has(b) || a.M.set(b, new Cd(a.S ? void 0 : function () {
            a.flush()
        }));
        return a.M.get(b)
    };
    Fd.prototype.flush = function () {
        ...
        if (this.url && this.ia) {
            ...
            b !== "" && Math.random() < this.ia && fetch(this.url + "?" + b, {
                method: "GET",
                mode: "no-cors",
                signal: window.AbortSignal ? AbortSignal.timeout(3E4) : void 0
            }).catch(function () {
            }).finally(function () {
                Ed(a)
            })
    ...
    Fd.prototype.setInterval = function (a) {
        this.W = a
    };
    var Ed = function (a) {
    ...
    var Kd = function (a, b, c) {
        c || (c = 0);
        var d = a.za;
        if (typeof b === "string") for (var e = 0; e < 16; e++) d[e] = b.charCodeAt(c) << 24 | b.charCodeAt(c + 1) << 16 | b.charCodeAt(c + 2) << 8 | b.charCodeAt(c + 3), c += 4; else for (e = 0; e < 16; e++) d[e] = b[c] << 24 | b[c + 1] << 16 | b[c + 2] << 8 | b[c + 3], c += 4;
        for (e = 16; e < 80; e++) {
        ...
        b = a.g[0];
        c = a.g[1];
        var g = a.g[2], k = a.g[3], h = a.g[4];
        for (e = 0; e < 80; e++) {
            if (e < 40) if (e < 20) {
                f = k ^ c & (g ^ k);
                var l = 1518500249
            } else f = c ^ g ^ k, l = 1859775393; else e < 60 ? (f = c & g | k & (c | g), l = 2400959708) :
    ...
    Jd.prototype.update = function (a, b) {
        if (a != null) {
            b === void 0 && (b = a.length);
            for (var c = b - this.blockSize, d = 0, e = this.T, f = this.C; d < b;) {
                if (f == 0) for (; d <= c;) Kd(this, a, d), d += this.blockSize;
                if (typeof a === "string") for (; d < b;) {
    ...
    Jd.prototype.digest = function () {
        ...
        Kd(this, this.T);
        for (c = b = 0; c < 5; c++) for (var d = 24; d >= 0; d -= 8) a[b] = this.g[c] >> d & 255, ++b;
        return a
    };
    var Ld = function () {
        this.aa = new Jd
    ...
    var Md = C.crypto, Nd = !1, Od = 0, Pd = 0, Qd = 1, Rd = 0, Sd = "", Td = function (a) {
        a = a || C.event;
        var b = a.screenX + a.clientX << 16;
        b += a.screenY + a.clientY;
        b *= (new Date).getTime() % 1E6;
        Qd = Qd * b % Rd;
        Od > 0 && ++Pd == Od && Gb("mousemove", Td, "remove", "de")
    }, Ud = function (a) {
        var b = new Ld;
    ...
    Nd = !!Md && typeof Md.getRandomValues == "function";
    Nd || (Rd = (screen.width * screen.width + screen.height) * 1E6, Sd = Ud(D.cookie + "|" + D.location + "|" + (new Date).getTime() + "|" + Math.random()), Od = W("random/maxObserveMousemove") || 0, Od != 0 && Gb("mousemove", Td, "add", "at"));
    var Vd = function () {
        var a = M.onl;
        if (!a) {
            a = F();
        ...
        b = b.onload;
        return typeof b === "function" ? (Vd().a(a, b), b) : null
    }, Xd = function (a) {
    ...
    var Zd = {
        ...
        vspace: "0",
        width: "100%"
    }, $d = {allowtransparency: !0, onload: !0}, ae = 0, be = function (a) {
        I(!a || Eb.test(a), "Illegal url for new iframe - " + a)
    }, ce = function (a, b, c, d, e) {
        be(c.src);
        var f, g = Wd(d, c), k = g ? Xd(d) : "";
        try {
            document.all && (f = a.createElement('<iframe frameborder="' + qb(String(c.frameborder)) + '" scrolling="' + qb(String(c.scrolling)) + '" ' + k + ' name="' + qb(String(c.name)) + '"/>'))
        } catch (l) {
        } finally {
            f ||
            (f = (a ? new eb(db(a)) : va || (va = new eb)).createElement("IFRAME"), g && (f.onload = function () {
                f.onload = null;
                g.call(this)
            }, Yd(d)))
        }
        f.setAttribute("ng-non-bindable", "");
        for (var h in c) a = c[h], h === "style" && typeof a === "object" ? H(a, f.style) : $d[h] || f.setAttribute(h, String(a));
        (h = e && e.beforeNode || null) || e && e.dontclear || Lb(b);
        b.insertBefore(f, h);
        f = h ? h.previousSibling : b.lastChild;
        c.allowtransparency && (f.allowTransparency = !0);
        return f
    };
    var de = /^:[\w]+$/, ee = /:([a-zA-Z_]+):/g, fe = function () {
        var a = Uc() || "0", b = Vc();
        var c = Uc() || a;
        var d = Vc(), e = "";
        ...
        var f = W("iframes/:socialhost:"), g = W("iframes/:im_socialhost:");
        return Fb = {
            socialhost: f,
    ...
    var ie = function (a) {
        ...
        a = b ? b : a;
        return Db(document, a)
    }, je = function (a) {
        a = a || "canonical";
        for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
            var e = b[c], f = e.getAttribute("rel");
            if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = ie(e)) && e.match(/^https?:\/\/[\w\-_\.]+/i) != null) return e
        }
        return window.location.href
    };
    var ke = {se: "0"}, le = {post: !0},
        me = {style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none"},
        ne = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "),
        oe = E(M, "WI", F()), pe = function (a, b, c) {
            var d;
            var e = {};
            var f = d = a;
            ...
            for (var g in ke) e[g] = g + "/" + (b[g] || ke[g]) + "/";
            e = Db(D, d.replace(ee,
                he(e)));
            g = "iframes/" + a + "/params/";
            f = {};
            ...
            le[a] || (f.origin = window.location.origin || window.location.protocol + "//" + window.location.host);
            f.exp = U(g + "exp");
            if (g = U(g + "location")) for (d = 0; d < g.length; d++) {
                var k = g[d];
                f[k] = C.location[k]
            }
            switch (a) {
                ...
                case "follow":
                    ...
                    g = (g = typeof g == "string" ? g : void 0) ? ie(g) : je(d);
                    f.url = g;
                    delete f.href;
                    break;
                case "plusone":
            ...
            delete f.rd;
            for (var h in ke) f[h] && delete f[h];
            ...
            Qc(function (b) {
                if (a !== b.id && b.state != 4 && b.type != "share") {
                    ...
                    if (f) {
                        var g = pe(d, b, 0);
                        g ? (f =
                            f.parentNode, te(e) !== te(g) && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, ue(f, b), (d = V[f.lastChild.id]) && (d.oid = c), Rc(c, 4))) : delete V[c]
                    } else delete V[c]
                }
            })
        }, te = function (a) {
    ...
    var Ta = ea(["data-"]), we, xe, ye, ze, Ae, Be = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        Ce = {plusone: !0, autocomplete: !0, profile: !0, signin: !0, signin2: !0};
    we = E(M, "SW", F());
    xe = E(M, "SA", F());
    ye = E(M, "SM", F());
    ze = E(M, "FW", []);
    ...
    var De = function (a, b) {
        ...
        if (c.querySelectorAll && (!e || e > 8)) {
            e = d ? [d] : rb(we).concat(rb(xe)).concat(rb(ye));
        ...
        for (f = 0; f < e.length; f++) {
            ...
            var h = g;
            k = d;
            var l = h.nodeName.toLowerCase(), m = void 0;
            if (h.hasAttribute("data-gapiscan")) k =
                null; else {
                var n = l.indexOf("g:");
                n == 0 ? m = l.substr(2) : (n = (n = String(h.className || h.getAttribute("class"))) && Be.exec(n)) && (m = n[1]);
                k = !m || !(we[m] || xe[m] || ye[m]) || k && m !== k ? null : m
            }
            k && (Ce[k] || g.nodeName.toLowerCase().indexOf("g:") == 0 || rb(se(g)).length != 0) && (bb(g), E(c, k, []).push(g))
        }
        if (b) for (var q in c) for (b = c[q], d = 0; d < b.length; d++) b[d].setAttribute("data-onload", !0);
        for (var v in c) ze.push(v);
        N("ps1", !0);
        if ((q = ze.join(":")) || a) try {
            K.load(q, a)
        } catch (t) {
        ...
        if (Ge(Ae || {})) for (var w in c) {
            ...
            d = [];
            for (w in c) for (a = c[w], v = 0, b = a.length; v < b; v++) e = a[v], Ie(w, e, se(e), d, b);
            Je(q, d)
        }
    }, Ke = function (a) {
        var b = E(K, a, {});
    ...
    var He = function (a, b) {
        ...
        b && c ? (c(b), (c = b.iframeNode) && c.setAttribute("data-gapiattached", !0)) : K.load(a, function () {
            var d = Pb(a), e = b && b.iframeNode, f = b && b.userParams;
            e && d ? (d(b), e.setAttribute("data-gapiattached", !0)) : (d = K[a].go, a == "signin2" ? d(e, f) : d(e && e.parentNode, f))
        })
    }, Ge = function () {
        return !1
    }, Je = function () {
        ...
        switch (Oe(b, a, f)) {
            ...
            case 1:
                if (b.parentNode) {
                    ...
                    Pc();
                    f = pe(a, c, e);
                    g = {allowPost: 1, attributes: me};
                    g.dontclear = !k;
                    e = {};
                    e.userParams = c;
                    e.url = f;
                    e.type = a;
                    if (c.rd) var h = b; else h = document.createElement("div"), b.dataset.gapistub = !0, h.style.cssText = "position:absolute;width:450px;left:-10000px;", b.parentNode.insertBefore(h, b);
                    e.siteElement = h;
                    h.id ||
                    (b = h, E(oe, a, 0), k = "___" + a + "_" + oe[a]++, b.id = k);
                    b = F();
                    b[">type"] = a;
                    H(c, b);
                    k = f;
                    ...
                    g = b = k;
                    de.test(b) && (g = W("iframes/" + g.substring(1) + "/url"), I(!!g, "Unknown iframe url config for - " + b));
                    k = Db(D, g.replace(ee, ge));
                    b = c.ownerDocument || D;
                    h = 0;
                    do g = f.id || ["I", ae++, "_", (new Date).getTime()].join(""); while (b.getElementById(g) && ++h < 5);
                    ...
                    m || (q = yd(L(b.location.href, "jcp", ""))) && typeof q == "object" && (m = (m = q.id) ? q.pfname + "/" + m : "");
                    n.pfname =
                        m;
                    f.connectWithJsonParam && (q = {}, q.jcp = zd(n), n = q);
                    ...
                    if (!q) {
                        if (!(q = f.rpctoken)) {
                            ...
                            Fd.ma || (Fd.ma = new Fd);
                            Dd(w(Fd.ma, 50));
                            Nd ? (w = new C.Uint32Array(1), Md.getRandomValues(w), w = Number("0." + w[0])) : (w = Qd, w += parseInt(Sd.substr(0, 20), 16), Sd = Ud(Sd), w /= Rd + Math.pow(16, 20));
                            q = q(v.call(m, w * 1E8))
                        }
                        n.rpctoken = q
                    }
                ...
                t && ((e = t.id) && d.push(e), He(a, t))
        }
    }, Oe = function (a, b, c) {
        if (a && a.nodeType === 1 && b) {
            if (c) return 1;
            if (ye[b]) {
                if (Mb[a.nodeName.toLowerCase()]) return (a = a.innerHTML) && a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") ? 0 : 1
            } else {
                if (xe[b]) return 0;
                if (we[b]) return 1
            }
        ...
        if (d) {
            ...
            Je(c,
                e)
        } else Nc.log("gapi." + c + ".render: missing element " + typeof a === "string" ? a : "")
    };
    E(K, "platform", {}).go = Fe;
    Ge = function (a) {
    ...
    var Ib = function (a) {
        ...
        for (a = 0; a < b.length; a++) Ke(b[a])
    };
    O.push(["platform", function (a, b, c) {
        Ae = c;
        (b || c.features) && ze.push(b || c.features.join(":"));
        Qe(Le, a);
        Qe(Me, c._c.annotation);
        Qe(Ne, c._c.bimodal);
        Gc();
        Ec();
        if (U("parsetags") != "explicit") {
            Ob(a);
            Lc(Kc()) && !U("disableRealtimeCallback") && Pc();
            if (c && (a = c.callback)) {
                var d = sb(a);
                delete c.callback
            }
    ...
    var Se = /^\{h:'/, Te = /^!_/, Ue = "", Pe = function (a, b) {
        function c() {
            Gb("message", d, "remove", "de")
        }

        function d(f) {
            var g = f.data, k = f.origin;
            if (Ve(g, b)) {
                var h = e;
                e = !1;
                h && N("rqe");
                We(a, function () {
                    h && N("rqd");
                    c();
                    for (var l = E(M, "RPMQ", []), m = 0; m < l.length; m++) l[m]({data: g, origin: k})
                })
            }
        }
        ...
        a = String(a);
        if (Se.test(a)) return !0;
        var c = !1;
        Te.test(a) && (c = !0, a = a.substr(2));
        if (!/^\{/.test(a)) return !1;
        var d = yd(a);
        if (!d) return !1;
        a = d.f;
        if (d.s && a && jb.call(b, a) != -1) {
            if (d.s === "_renderstart" || d.s === Ue + "/" + a + "::_renderstart") if (d = d.a && d.a[c ? 0 : 1], b = D.getElementById(a), Rc(a, 2), d && b && (c = b.parentNode, d.width && d.height)) {
                a:{
                    a = d || {};
                    if (Oc()) {
                        var e = b.id;
                    ...
                    (d = c.nextSibling) && d.dataset && d.dataset.gapistub && (c.parentNode.removeChild(d), c.style.cssText = "");
                    d = a.width;
    ...
    Xe.prototype.write = function (a, b) {
        if (!Ye.test(this.Y)) throw "Invalid cookie name";
        if (!Ze.test(a)) throw "Invalid cookie value";
        a = this.Y + "=" + a;
    ...
    var Ze = /^[-+/_=.:|%&a-zA-Z0-9@]*$/, Ye = /^[A-Z_][A-Z0-9_]{0,63}$/;
    ...
    var Z = {};
    $e.iterate = function (a) {
        for (var b in Z) Z.hasOwnProperty(b) && a(b, Z[b])
    };
    var af = window.location.protocol === "https:", bf = af || window.location.protocol === "http:" ? Xe : $e,
        cf = function (a) {
            ...
            return {o: a.charAt(0) == "S", domain: d, B: c}
        }, df = function () {
            var a, b = null;
            bf.iterate(function (c, d) {
                c.indexOf("G_AUTHUSER_") === 0 && (c = cf(c.substring(11)), !a || c.o && !a.o || c.o == a.o && c.B > a.B) && (a = c, b = d)
            });
            return {Ba: a, R: b}
        };
    ...
    function ef(a) {
        ...
        if (d == -1) return b;
        var e = cf(a.substr(d + 1));
        if (e == null) return b;
        a = a.substring(0, d);
        if (a.charAt(0) !== "_") return b;
        d = c === "E" && e.o;
        return !d && (c !== "U" || e.o) || d && !af ? b : {la: !0, o: d, Sa: a.substr(1), domain: e.domain, B: e.B}
    }
    ...
    var ff = function (a) {
        ...
        a = a.split(":");
        return {clientId: a[0].split("=")[1], Na: ff(a[1]), Ua: ff(a[2]), Ta: ff(a[3])}
    }, hf = function () {
        var a = df(), b = a.Ba;
        a = a.R;
        if (a !== null) {
            var c;
            bf.iterate(function (f, g) {
                (f = ef(f)) && f.la && f.o == b.o && f.B == b.B && (c = g)
            });
            if (c) {
                var d = gf(c), e = d && d.Na[Number(a)];
                d = d && d.clientId;
                if (e) return {R: a, Ma: e, clientId: d}
            }
        }
        return null
    };
    ...
    Pc = function () {
        ...
        M.oa = !0;
        var a = hf();
        (a = a && a.R) && Fc("googleapis.config/sessionIndex", a);
        lf || (lf = E(M, "ss", new kf));
        a = lf;
        a.va && a.va()
    };
    var jf = function () {
        var a = hf(), b = a && a.Ma || null, c = a && a.clientId;
        wc("auth", {
            callback: function () {
                var d = C.gapi.auth, e = {client_id: c, session_state: b};
                d.checkSessionState(e, function (f) {
                    var g = e.session_state, k = !!U("isLoggedIn");
                    f = U("debug/forceIm") ? !1 : g && f || !g && !f;
                    if (k = k !== f) Fc("isLoggedIn", f), Pc(), ve(), f || ((f = d.signOut) ? f() : (f = d.setToken) && f(null));
                    f = Kc();
                    var h = U("savedUserState");
                    g = d._guss(f.cookiepolicy);
                    h = h != g && typeof h != "undefined";
                    Fc("savedUserState", g);
                    (k || h) && Lc(f) && !U("disableRealtimeCallback") && d._pimf(f,
                        !0)
                })
            }
        });
    ...
    window.gapi.load("", {
        callback: window["gapi_onload"], _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.2ttuSS2XBQ8.O/am=AACA/d=1/rs=AHpOoo-TYe36ShA0ds8KrukIhF82BwaKlg/m=__features__",
